...
##Buttons
##IO_L20N_T3_34
set_property PACKAGE_PIN R18 [get_ports {alarm_off_tri_i[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {alarm_off_tri_i[0]}]
...
set_property PACKAGE_PIN N15 [get_ports {alarm_sound_tri_o[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {alarm_sound_tri_o[0]}]
